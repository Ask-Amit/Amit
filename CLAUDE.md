...
**NEXT SESSION — first task:** re-enable and verify Devotions.html's `onAuthStateChange` listener now that the real bug behind tonight's flicker is fixed and confirmed unrelated to it.
