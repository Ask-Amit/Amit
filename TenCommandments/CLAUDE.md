...
**Enforcement note, added 2026-07-18 after Ryan caught this being missed twice in a row (Commandments 6 and 7 both shipped without it):** Section 5 of every commandment must explicitly close with the love-not-legalism framing described in point (c) above — not implied, not left for the reader to infer from tone, an actual stated paragraph naming that the commandment never went away because it was never a burden, using language close to Ryan's own: "it isn't gone away with, it's just our love walk." Before marking any commandment complete, check Section 5 specifically for this paragraph. Its absence is the single most common way this project's whole stated purpose (love became a person) fails to actually show up on the page.
